/**
 Modify the implementation of BFS in Task 2 
 to also store the distance of each node from the source.
Add the distance attribute to the graph_node struct and 
initialize it to 2 * |V|.
 Update it in the BFS algorithm such that it stores the 
